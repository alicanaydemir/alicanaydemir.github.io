...
public class MovieToWatchAdapter extends RecyclerView.Adapter<MovieToWatchAdapter.MyViewHolder> {

    private List<Movie> movieList;
    private Context context;

    public MovieToWatchAdapter(Context context, List<Movie> movieList) {
    ...
    @Override
    public MovieToWatchAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
